...
# Auto-generated granular test for controls["edtech.ca_pipeda_consent_edtech"]
test_denies_when_controls_edtech_ca_pipeda_consent_edtech_failing if {
	some _ in deny with input as {"controls": {}, "pipeda": {"consent_obtained": true}, "controls[\"edtech": {"ca_pipeda_consent_edtech\"]": false}}
}
