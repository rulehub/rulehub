...
# Auto-generated granular test for controls["legaltech.ccpa_notice_at_collection"]
test_denies_when_controls_legaltech_ccpa_notice_at_collection_failing if {
	some _ in deny with input as {"controls": {}, "ccpa": {"notice_at_collection_provided": true}, "controls[\"legaltech": {"ccpa_notice_at_collection\"]": false}}
}
