...
def write_markdown_report(out_path: Path, missing: List[str], orphan: List[str], broken: List[str]) -> None:
    ...
    lines = ["# Docs Nav Audit", "",
             "Generated by tools/docs_nav_audit.py", ""]
...
def main(argv: List[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Docs navigation audit against docs/ tree")
    parser.add_argument("--mkdocs", type=Path,
                        default=Path("mkdocs.yml"), help="Path to mkdocs.yml")
    parser.add_argument("--docs-dir", type=Path,
                        default=Path("docs"), help="Docs directory to scan")
    parser.add_argument(
        "--out",
        type=Path,
